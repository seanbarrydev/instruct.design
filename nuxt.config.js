...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { name: 'keywords', content: 'instructional design, sean barry, training, curriculum, graphic design, web development, analytics, customer education, product management, digital media, marketing' },
      {
  ...
  fontawesome: {
    icons: {
      solid: ['faMoon', 'faVideo', 'faLaptop', 'faGraduationCap', 'faLaptopCode', 'faDesktop', 'faBook',
        'faPodcast', 'faPenAlt', 'faTabletAlt', 'faChalkboardTeacher', 'faArrowLeft', 'faArrowRight', 'faHashtag',
        'faChartLine', 'faPalette', 'faHandsHelping', 'faCogs', 'faPhotoVideo', 'faExternalLinkAlt'
      ],
      regular: ['faMoon']
    }
  },
